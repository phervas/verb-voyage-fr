...
export const IRREGULAR_VERBS: IrregularVerb[] = [
  ...
  { infinitive: "can", past: "could", pastParticiple: "been able to", french: "pouvoir" },
  ...
  { infinitive: "get", past: "got", pastParticiple: "got", french: "obtenir" },
...
export const SAMPLE_SENTENCES = {
  be: ["Yesterday, I _____ happy.", "I have _____ happy today."],
  beat: ["Our team _____ them yesterday.", "Our team has _____ them before."],
  become: ["She _____ my friend last year.", "She has _____ very brave."],
  begin: ["The lesson _____ at 9 o’clock.", "The lesson has _____ already."],
  bite: ["The dog _____ my shoe yesterday.", "The dog has _____ my shoe again."],
  break: ["He _____ his toy yesterday.", "He has _____ his toy again."],
  bring: ["She _____ her book yesterday.", "She has _____ her book today."],
  build: ["They _____ a sandcastle yesterday.", "They have _____ a big one."],
  buy: ["Mum _____ apples yesterday.", "She has _____ apples again."],
  can: ["Yesterday, I _____ swim.", "I have _____ swim since I was 6."],
  catch: ["He _____ the ball yesterday.", "He has _____ the ball many times."],
  choose: ["She _____ the blue one yesterday.", "She has _____ the blue one again."],
  come: ["My friend _____ to my house yesterday.", "My friend has _____ to my house."],
  cost: ["This book _____ 5 euros.", "This book has _____ 5 euros all week."],
  do: ["We _____ homework yesterday.", "We have _____ homework already."],
  drink: ["He _____ water yesterday.", "He has _____ water today."],
  drive: ["Dad _____ to school yesterday.", "Dad has _____ there many times."],
  eat: ["We _____ pizza yesterday.", "We have _____ pizza before."],
  fall: ["He _____ off his bike yesterday.", "He has _____ off his bike before."],
  feel: ["I _____ tired yesterday.", "I have _____ tired today."],
  fight: ["They _____ yesterday.", "They have _____ before."],
  find: ["She _____ her keys yesterday.", "She has _____ her keys."],
  fly: ["The bird _____ away yesterday.", "The bird has _____ away again."],
  forget: ["I _____ my lunch yesterday.", "I have _____ my lunch again."],
  get: ["I _____ a new sticker yesterday.", "I have _____ a new sticker."],
  give: ["She _____ me a gift yesterday.", "She has _____ me a gift."],
  go: ["We _____ to the park yesterday.", "We have _____ to the park before."],
  grow: ["The plant _____ a lot last week.", "The plant has _____ a lot."],
  have: ["I _____ a test yesterday.", "I have _____ a test today."],
  hear: ["I _____ a funny noise yesterday.", "I have _____ that noise before."],
  know: ["I _____ the answer yesterday.", "I have _____ the answer for days."],
  leave: ["She _____ school early yesterday.", "They have _____ for Paris already."],
  lose: ["He _____ the game yesterday.", "I have _____ my keys again."],
  make: ["She _____ a cake yesterday.", "They have _____ a big cake."],
  meet: ["We _____ at the park last week.", "I have _____ many new friends."],
  ...
  read: ["He _____ a story yesterday.", "I have _____ this book three times."],
  ride: ["She _____ her bike yesterday.", "I have _____ a horse once."],
  ring: ["The phone _____ yesterday.", "She has _____ the bell already."],
  run: ["He _____ fast yesterday.", "We have _____ in the park many times."],
  say: ["She _____ hello yesterday.", "He has _____ the answer."],
  ...
  sing: ["She _____ a song yesterday.", "We have _____ together before."],
  ...
  speak: ["He _____ to the teacher yesterday.", "She has _____ English for years."],
  spend: ["We _____ the afternoon at the park.", "I have _____ my pocket money."],
  stand: ["He _____ in line yesterday.", "We have _____ here a long time."],
  ...
  take: ["She _____ the bus yesterday.", "I have _____ many photos."],
  teach: ["Ms. Lee _____ us a song.", "He has _____ maths for years."],
  tell: ["Dad _____ us a story.", "She has _____ me the truth."],
  think: ["I _____ about the answer.", "He has _____ of a great idea."],
  understand: ["I _____ the rule yesterday.", "She has _____ the homework."],
  wake: ["I _____ up early yesterday.", "I have _____ up early all week."],
  wear: ["He _____ a hat yesterday.", "He has _____ that hat before."],
  win: ["We _____ the game yesterday.", "We have _____ many games."],
  write: ["She _____ a story yesterday.", "She has _____ three stories." ]
};
